...
import DemoApp from './demoApp/DemoApp.vue'
...
const isDemoServer = window.location.port === '8500' || Boolean((import.meta as { env?: { DEV?: boolean } }).env?.DEV && window.location.port === '8500')
...
const RootComponent = isDemoServer
  ? DemoApp
  : currentWindowLabel === 'spotlight'
    ? SpotlightSearch
    : App
